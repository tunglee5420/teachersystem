...
public class User implements Serializable {
  ...
  private long doubleTeacher=-2;//是否双师型 0表示不是，1 表示是(-2表示默认初值)
  private long background=-2;//是否具有行业背景 0表示不是，1 表示是(-2表示默认初值)
  private long tutor=-2;//是否博硕士生导师 0表示不是，1 表示是(-2表示默认初值)
